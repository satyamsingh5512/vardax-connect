      ...
      >
        <div className="mb-8">
          ...
          <p className="text-enterprise-text-secondary">
            WAF rule configuration and policy management
          </p>
        </div>
        ...
        >
          ...
          <p className="text-enterprise-text-secondary mb-8 max-w-2xl mx-auto">
            Comprehensive WAF rule management with automated rule generation, 
            A/B testing, and intelligent rule optimization.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              <Settings className="w-8 h-8 text-brand-primary mx-auto mb-4" />
              <h3 className="font-semibold text-enterprise-text mb-2">Rule Builder</h3>
            ...
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              ...
              <h3 className="font-semibold text-enterprise-text mb-2">Auto-Generation</h3>
              <p className="text-sm text-enterprise-text-muted">
                AI-powered rule generation from threat patterns
              </p>
            </div>
            
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              <CheckCircle className="w-8 h-8 text-brand-primary mx-auto mb-4" />
              <h3 className="font-semibold text-enterprise-text mb-2">Testing & Validation</h3>
              <p className="text-sm text-enterprise-text-muted">
                Rule testing and performance validation
              </p>
            </div>
          </div>
