      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-enterprise-text-secondary">
            Advanced analytics and business intelligence for security operations
          </p>
        </div>
        ...
        >
          ...
          <p className="text-enterprise-text-secondary mb-8 max-w-2xl mx-auto">
            Comprehensive analytics dashboard with custom reports, trend analysis, 
            predictive modeling, and executive-level security metrics.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              ...
              <h3 className="font-semibold text-enterprise-text mb-2">Trend Analysis</h3>
            ...
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              <PieChart className="w-8 h-8 text-brand-primary mx-auto mb-4" />
              <h3 className="font-semibold text-enterprise-text mb-2">Custom Reports</h3>
              <p className="text-sm text-enterprise-text-muted">
                Build and schedule custom security reports
              </p>
            </div>
            
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              <LineChart className="w-8 h-8 text-brand-primary mx-auto mb-4" />
              <h3 className="font-semibold text-enterprise-text mb-2">KPI Dashboards</h3>
              <p className="text-sm text-enterprise-text-muted">
            ...
            <div className="bg-enterprise-elevated border border-enterprise-border-light rounded-lg p-6">
              ...
              <h3 className="font-semibold text-enterprise-text mb-2">Data Export</h3>
              <p className="text-sm text-enterprise-text-muted">
                Export data to BI tools and SIEM platforms
              </p>
            </div>
          </div>
